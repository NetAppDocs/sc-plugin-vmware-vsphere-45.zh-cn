...
+
如果显示消息 `Sselected virtual machine is not SnapCenter compatible or selected datastore is not SnapCenter compatible` ，则选定虚拟机或数据存储库与 SnapCenter 不兼容。请参见  compatibility check failures 有关详细信息 ...
